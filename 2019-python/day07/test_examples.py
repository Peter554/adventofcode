from app import run_permutation, run_permutation_with_feedback


def test_example_1():
    raw_code = "3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0"
    out = run_permutation((4, 3, 2, 1, 0), raw_code)
    assert out == 43210
...
def test_example_5():
    ...
    out = run_permutation_with_feedback((9, 7, 8, 5, 6), raw_code)
    assert out == 18216
